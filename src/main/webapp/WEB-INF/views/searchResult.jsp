        ...
        <nav class="main">
            <ul>
                <li class="search">
                    ...
                    <form id="search" method="get" action="search.board">
    ...
    <div id="main">
        ...
        <c:forEach var="post" items="${boardList}">
            ...
            <article class="post">
                <header>
                    <div class="title">
                        <h2><a href="specific.board?idx=${post.idx}">
                                ${fn:escapeXml(post.title)}</a></h2>
                        <p>
                                ${fn:length(post.content) > 60 ? fn:substring(post.content, 0, 60) : post.content}...
                        </p>
                    </div>
                ...
                <p>${fn:length(post.content) > 120 ? fn:substring(post.content, 0, 120) : post.content}...</p>
                <footer>
                    <ul class="stats">
